        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SUCCESS:
                    ...
                    Toast.makeText(JsonActivity.this, "获取数据成功", Toast.LENGTH_SHORT)
                            .show();
                    break;

                case FAILURE:
                    Toast.makeText(JsonActivity.this, "获取数据失败", Toast.LENGTH_SHORT)
                            .show();
                    break;

                case ERRORCODE:
                    Toast.makeText(JsonActivity.this, "获取的CODE码不为200！",
